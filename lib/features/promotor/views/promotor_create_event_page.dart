...
class PromotorCreateEventPage extends StatefulWidget {
  ...
  @override
  State<PromotorCreateEventPage> createState() =>
      _PromotorCreateEventPageState();
}
...
class _PromotorCreateEventPageState extends State<PromotorCreateEventPage> {
  ...
  Future<DateTime?> _pickSalesEndDate(DateTime? initial) {
  ...
  Future<TimeOfDay?> _pickSalesEndTime(TimeOfDay? initial) {
            ...
            child: Column(
              ...
              children: [
                ...
                DropdownButtonFormField<String>(
                  ...
                  items: _ticketTypes.map((t) => DropdownMenuItem(
                ...
                TextField(
                  ...
                  decoration: _inputDeco().copyWith(hintText: '0', hintStyle: const TextStyle(color: Colors.white38)),
                ),
                const SizedBox(height: 14),
  ...
  Future<void> _submit(String status) async {
    ...
    if (userId == null) {
      ScaffoldMessenger.of(context).showSnackBar(
        const SnackBar(content: Text('You must be logged in to publish an event')),
      );
      return;
    }
    ...
    try {
      await PromotorApi.instance.createEvent(
        userId: userId,
