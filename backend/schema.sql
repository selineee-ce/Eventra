...
('brand.name', 'EVENTRA'),
('auth.login.subtitle', 'Unlock the night''s best experiences!'),
('auth.login.identifier_hint', 'Email, phone, or username'),
('auth.login.password_hint', 'Password'),
('auth.login.submit', 'Log in'),
('auth.login.signup_prompt', 'Don''t have an account? '),
('auth.login.signup_action', 'Sign up'),
('auth.register.title', 'Create Account'),
('auth.register.subtitle', 'Explore the best upcoming events!'),
...
('auth.register.login_action', 'Log in'),
('home.drops_eyebrow', 'LIMITED ACCESS'),
('home.drops_title', 'Exclusive Drops'),
